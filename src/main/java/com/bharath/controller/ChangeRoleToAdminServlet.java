...
/**
 * This servlet will change the role of user to admin - which is an admin action
...
public class ChangeRoleToAdminServlet extends HttpServlet {
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String apiUrl = "http://localhost:8080/BharathSocialMediaAppRestFullWebServ/webapi/user/"+users.getUserId_()+"/changeRoleToAdmin/"+targetUserId; 
